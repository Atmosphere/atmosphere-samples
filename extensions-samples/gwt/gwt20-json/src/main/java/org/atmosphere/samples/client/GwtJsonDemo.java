...
public class GwtJsonDemo implements EntryPoint {
    ...
    public void onModuleLoad() {
        ...
        RequestConfig jsonRequestConfig = AtmosphereRequestConfig.create(json_serializer);
        ...
        final AtmosphereServerRequest jsonRequest = atmosphere.subscribe(jsonRequestConfig);
