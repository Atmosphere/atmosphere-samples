...
import org.atmosphere.gwt20.client.RequestConfig.Flags;
...
public class GwtJerseyDemo implements EntryPoint {
    ...
    public void onModuleLoad() {
        ...
        RequestConfig jerseyRpcRequestConfig = AtmosphereRequestConfig.create(rpc_serializer);
...
//        rpcRequestConfig.setFlags(Flags.trackMessageLength);
        ...
        final AtmosphereServerRequest jerseyRpcRequest = atmosphere.subscribe(jerseyRpcRequestConfig);
